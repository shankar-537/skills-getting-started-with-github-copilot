...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training and matches for soccer players",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "aiden@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice dribbling, shooting, and team play",
    ...
    "Debate Team": {
        "description": "Research issues and practice public speaking and argumentation",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["elizabeth@mergington.edu", "grace@mergington.edu"]
    }
}
